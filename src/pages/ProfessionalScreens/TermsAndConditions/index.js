...
export default class PrTermsAndConditions extends Component{
      ...
      <>
        ...
        <View style={styles.container}>
          <ScrollView 
            ...
            <TouchableOpacity disabled={ !this.state.accepted } onPress={() => navigation.navigate('CurriculumViewer')} style={ this.state.accepted ? styles.button : styles.buttonDisabled }><Text style={styles.buttonLabel}>Aceitar</Text></TouchableOpacity>
        </View>
      </>
    );
  }
