        ...
        <ScrollView>
          ...
          <Form>
            ...
            <DropdownView>
              <RNPickerSelect
                useNativeAndroidPickerStyle={false}
                Icon={() => <Icon name="briefcase" size={20} style={{right: 242, color: '#28b45d', top: 13}} />}
                placeholder={{
                ...
                items={[
                    ...
                    { label: 'Cuidador de Idosos', value: 'fem' },
                ]}
              />
            </DropdownView>
            <SubmitButton 
              onPress ={() => navigation.navigate('PrTermsAndConditions')}> Avançar 
            </SubmitButton>
          </Form>
        </ScrollView>
      </Container>
